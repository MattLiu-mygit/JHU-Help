...
const ChildcarePage = () => {
    return (<>
        ...
        <p></p>
        <h6>Homeschooling</h6>
        <Collapsible className='outerCollapsible' title='CovEd' content={<>
        ...
        <Collapsible className='outerCollapsible' title='Khan Academy' content={<>
        ...
        <Collapsible className='outerCollapsible' title='Scholastic Learn at Home' content={<>
        ...
        <Collapsible className='outerCollapsible' title='No Red Ink' content={<>
        ...
        <Collapsible className='outerCollapsible' title='CodeAcademy' content={<>
